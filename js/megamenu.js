// JavaScript Document For The mega Menu of DIET
...
$(document).ready(function(e) {	 
	...
	$('.main-menu li').each(function(index, element) {
		if($(this).children('div').length > 0){
			$(this).find('> a').append('<span class="indicator"><i class="fa fa-angle-down"></i></span>');
...
function menu_toggle(){		
	//$('.megamenu-division .container .showhide').css('display', 'block');
	//$('.megamenu-division .container').prepend('');	
...
$(window).resize(function(e){
	if($(document).innerWidth() > 940){
		...
		//$('.megamenu-division .container .showhide').css('display', 'none');
...
$(document).ready(function(e) {
	//alert($('.carousel-division').innerWidth());
	if($(document).innerWidth()>940){
		...
		$('#main_menu .nav-menu .nav-item').each(function(index, element) {
			...
			$(this).parent().append('<li class="btn-more-li"><a class="btn-more" id="btn-more-toggle" href="#" title="More"><span>More</span></a></li>');
